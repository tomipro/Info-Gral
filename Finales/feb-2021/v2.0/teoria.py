...
El operador de modulo "%" se utiliza para obtener el remanente de la division del numero a la izquierda por el de la derecha. 
La division entre un entero y 1 retorna un remanente de 0. 
